...
--
-- Хост: localhost
-- Время создания: Фев 20 2023 г., 15:55
...
INSERT INTO `students` (`id`, `name`, `course_id`, `description`, `email`, `phone`, `country`) VALUES
(1, 'Andrey', 1, '', '', '+375297564756', 'Belarus'),
(2, 'Ivan', 1, 'Test description', '', NULL, 'Russia'),
(3, 'Ivan', 1, 'dfdsf', '', NULL, 'Russia');
...
INSERT INTO `teachers` (`id`, `surname`, `name`, `course_id`, `email`, `phone`, `description`, `image_url`) VALUES
(1, 'dfgd', 'dfgdfg', 1, '', NULL, NULL, NULL);
